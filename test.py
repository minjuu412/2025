...
good_combos = {
    ...
    ("B", "쌍둥이자리"): [("A", "황소자리"), ("AB", "천칭자리")],
    ("B", "게자리"): [("O", "전갈자리"), ("AB", "물고기자리")],
    ("B", "사자자리"): [("O", "양자리"), ("A", "사수자리")],
    ("B", "처녀자리"): [("A", "황소자리"), ("O", "염소자리")],
    ("B", "천칭자리"): [("O", "쌍둥이자리"), ("AB", "물병자리")],
    ("B", "전갈자리"): [("O", "게자리"), ("AB", "물고기자리")],
    ("B", "사수자리"): [("O", "사자자리"), ("A", "양자리")],
    ("B", "염소자리"): [("A", "황소자리"), ("O", "처녀자리")],
    ("B", "물병자리"): [("AB", "쌍둥이자리"), ("O", "천칭자리")],
    ("B", "물고기자리"): [("AB", "게자리"), ("O", "전갈자리")],

    ("O", "양자리"): [("A", "사자자리"), ("B", "사수자리")],
    ("O", "황소자리"): [("A", "처녀자리"), ("B", "황소자리")],
    ("O", "쌍둥이자리"): [("B", "천칭자리"), ("AB", "물병자리")],
    ("O", "게자리"): [("A", "게자리"), ("AB", "물고기자리")],
    ("O", "사자자리"): [("A", "양자리"), ("B", "사수자리")],
    ("O", "처녀자리"): [("A", "황소자리"), ("B", "천칭자리")],
    ("O", "천칭자리"): [("B", "쌍둥이자리"), ("AB", "물병자리")],
    ("O", "전갈자리"): [("A", "게자리"), ("B", "물고기자리")],
    ("O", "사수자리"): [("A", "사자자리"), ("B", "양자리")],
    ("O", "염소자리"): [("A", "황소자리"), ("B", "처녀자리")],
    ("O", "물병자리"): [("AB", "천칭자리"), ("A", "물병자리")],
    ("O", "물고기자리"): [("AB", "게자리"), ("B", "전갈자리")],

    ("AB", "양자리"): [("A", "사자자리"), ("O", "사수자리")],
    ("AB", "황소자리"): [("B", "처녀자리"), ("O", "염소자리")],
    ("AB", "쌍둥이자리"): [("A", "천칭자리"), ("B", "물병자리")],
    ("AB", "게자리"): [("O", "전갈자리"), ("A", "물고기자리")],
    ("AB", "사자자리"): [("O", "양자리"), ("B", "사수자리")],
    ("AB", "처녀자리"): [("A", "황소자리"), ("B", "천칭자리")],
    ("AB", "천칭자리"): [("O", "쌍둥이자리"), ("A", "물병자리")],
    ("AB", "전갈자리"): [("B", "게자리"), ("O", "물고기자리")],
    ("AB", "사수자리"): [("A", "사자자리"), ("B", "양자리")],
    ("AB", "염소자리"): [("O", "황소자리"), ("B", "처녀자리")],
    ("AB", "물병자리"): [("A", "천칭자리"), ("O", "물병자리")],
    ("AB", "물고기자리"): [("B", "게자리"), ("A", "전갈자리")],
}
