...
style_recommendations = {
    "A": {
        ...
        "황소자리": "편안한 캐주얼로 안정감 있는 느낌!",
        "쌍둥이자리": "트렌디한 아이템으로 변화를 줘보세요.",
        "게자리": "따뜻한 색감의 포근한 스타일!",
        "사자자리": "화려한 액세서리로 포인트!",
        "처녀자리": "깔끔하고 미니멀한 스타일 추천.",
        "천칭자리": "밸런스 좋은 세련된 스타일!",
        "전갈자리": "강렬한 컬러로 개성 표현!",
        "사수자리": "자유로운 분위기의 캐주얼 추천.",
        "염소자리": "클래식하고 단정한 스타일!",
        "물병자리": "독특하고 실험적인 패션 시도!",
        "물고기자리": "로맨틱하고 부드러운 스타일.",
    },
    "B": {
        "양자리": "스포티하면서 밝은 컬러 추천!",
        "황소자리": "자연스러운 톤으로 편안하게.",
        "쌍둥이자리": "톡톡 튀는 포인트 아이템 필수!",
        "게자리": "포근하고 따뜻한 느낌 추천.",
        "사자자리": "눈에 띄는 화려한 스타일 OK!",
        "처녀자리": "깔끔하게 정돈된 스타일 추천.",
        "천칭자리": "조화로운 패션으로 균형 유지!",
        "전갈자리": "미스터리한 느낌의 컬러 추천.",
        "사수자리": "자유로운 무드의 캐주얼 스타일.",
        "염소자리": "단정하고 클래식한 아이템 추천.",
        "물병자리": "독특함을 살린 실험적 패션.",
        "물고기자리": "부드럽고 몽환적인 스타일 추천.",
    },
    "AB": {
        "양자리": "활기찬 느낌과 개성 강조!",
        "황소자리": "편안하고 자연스러운 스타일 추천.",
        "쌍둥이자리": "다양한 스타일 믹스 시도 가능!",
        "게자리": "따뜻하고 포근한 무드 강조.",
        "사자자리": "강렬한 포인트 아이템 필수!",
        "처녀자리": "깔끔하게 정돈된 세련된 느낌.",
        "천칭자리": "밸런스를 맞춘 심플한 스타일.",
        "전갈자리": "독특한 포인트로 개성 표현.",
        "사수자리": "자유롭고 활동적인 스타일 추천.",
        "염소자리": "클래식하고 안정감 있는 느낌.",
        "물병자리": "실험적인 디자인 도전 추천.",
        "물고기자리": "부드럽고 로맨틱한 스타일 강조.",
    },
    "O": {
        "양자리": "에너지 넘치는 스포티 캐주얼 추천!",
        "황소자리": "자연스러운 컬러와 편안함!",
        "쌍둥이자리": "포인트 아이템으로 변화를!",
        "게자리": "따뜻한 색감으로 포근함 연출.",
        "사자자리": "화려한 스타일로 시선 집중!",
        ...
        "천칭자리": "세련된 밸런스 스타일 추천.",
        "전갈자리": "강렬한 컬러로 개성 표현!",
        "사수자리": "활동적인 캐주얼 스타일 추천.",
        "염소자리": "클래식하게 안정감 있게.",
        "물병자리": "독창적인 아이템으로 개성 표현.",
        "물고기자리": "몽환적이고 로맨틱한 스타일 추천.",
    },
}
